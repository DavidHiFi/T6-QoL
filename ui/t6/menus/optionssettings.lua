...
CoD.OptionsSettings.CreateQolCheatsTab = function (QolCheatsTab, LocalClientIndex)
	...
	--  so you reload normally and never run dry. Independent dvars, so either or
	--  both can be on; see zmqol_infinite_ammo_think() in quality_of_life.gsc.
	-- ========================================================================
	T(QolCheatsButtons, LocalClientIndex, "INFINITE AMMO",   "infinite_ammo",  "Reserves never run out. You still reload.")
	T(QolCheatsButtons, LocalClientIndex, "BOTTOMLESS CLIP", "bottomless_clip","Your magazine never empties, so you never reload.")
