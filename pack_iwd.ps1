...
try {
    ...
    # AIType overrides carry the Wave Gun's twelve Moon death-animation
    # references on both VM instances. Without these, the engine rejects the
    # augmented ASD before gameplay begins.
