...
{
    // DLC5 Moon Wave Gun death animations. These references must be compiled
    // into every AIType before precacheanimstatedef validates the ASD.
    ...
    dummy_anim_ref = %ai_zombie_crawl_microwave_death_walking_c;    dummy_anim_ref = %ai_zombie_idle_v1_delta;
