...
struct_init()
{
	...
	scripts\zm\replaced\utility::register_map_spawn((1675, 2006, 3415), (0, 0, 0), zone);
	scripts\zm\replaced\utility::register_map_spawn((1675, 1706, 3415), (0, 0, 0), zone);
...
precache()
{
	...
	precachemodel( "p6_zm_hr_concrete_pillar_01" );
	precachemodel( "p6_zm_hr_concrete_pillar_02" );
	precachemodel( "p6_zm_hr_concrete_slabs_lrg_01" );
	precachemodel( "p6_zm_hr_concrete_slabs_lrg_02" );
	precachemodel( "p6_zm_hr_concrete_slabs_lrg_03" );
	precachemodel( "p6_zm_hr_concrete_slabs_lrg_04" );
}
