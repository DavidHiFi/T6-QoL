...
precache()
{
	...
	precachemodel( "p6_zm_bu_conservatory_tree_roots_a" );
	precachemodel( "p6_zm_bu_conservatory_tree_roots_a_close" );
}
...
main()
{
	...
	// zm_qol: guarded - see the note in zm_transit_loc_diner.gsc::main.
	if ( isdefined( level.zones ) && isdefined( level.zones["zone_mansion"] ) )
...
{
	// mansion left
	scripts\zm\locs\loc_common::barrier("collision_wall_128x128x10_standard", (3396.1, 556.795, 246.125), (0, 90, 0), 1);
	scripts\zm\locs\loc_common::barrier("p6_zm_bu_conservatory_tree_roots_a_close", (3368.72, 561.516, 234.577), (179, 90, 38));

	// mansion right
	scripts\zm\locs\loc_common::barrier("collision_geo_256x256x256_standard", (3332.03, 1123.32, 435.4592), (0, 0, 0), 1);
	scripts\zm\locs\loc_common::barrier("collision_geo_256x256x256_standard", (3332.03, 1123.32, 179.4592), (0, 0, 0), 1);
